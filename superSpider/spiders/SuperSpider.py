    ...
    def after_login(self, response):
       ...
       # print self.cookie
        ...
        formdata=urllib.urlencode({
                                        ...
                                        'resultchk':'N',
                                        'SDay':self.SDay,
                                        'resResultdate':self.resResultdate,
                                        'AreaSelect':'1',
                                        'resSiDo':'00',
                                        'resSiGuGun':'',
                                        'resEMDong':'',
                                        ...
                                        'l_addr1':'',
                                        'l_addr2':'',
                                        'resTotGamAmt1':self.resTotGamAmt1,
                                        'resTotGamAmt2':self.resTotGamAmt2,
                                        'resTotLowestAmt1':'',
                                        'resTotLowestAmt2':'',
                                        'reslandArea1':'',
                                        'reslandArea2':'',
...
#            print self.cookie
       ...
       # Create an new Excel file and add a worksheet.
        fileName = self.nowYear+self.nowMonth+self.nowDay+"_"+"경매물건DB.xlsx".encode('cp949','ignore')
        ...
        for pageNo in range(1,NumOfTotalPage+1):
            formdata = urllib.urlencode({
                                            ...
                                            "resSiGuGun":"",
                                            "resEMDong":"",
                                            "resYear1":self.resYear1,
                                            "resMonth1":self.resMonth1,
                                            "resday1":self.resday1,
                                            "resYear2":self.resYear2,
                                            "resMonth2":self.resMonth2,
                                            "resday2":self.resday2,
                                            "resTotGamAmt1":self.resTotGamAmt1,
                                            "resTotGamAmt2":self.resTotGamAmt2,
                                            "resTotLowestAmt1":"",
                                            "resTotLowestAmt2":"",
